...
// and the a11y addon fails it on violations. Screenshots are not taken here: they are shot from
// the built site (playwright.config.ts), because this run renders through the dev transform. The addon applies the preview
